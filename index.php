...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/hill.jpg" alt="Los Angeles" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/rajshahi.png" alt="Chicago" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img src="images/beauty.jpg" alt="New York" width="1100" height="500">
    </div>
  </div>
    	...
    	<div class="row">
    		<div class="col-lg-4 col-md-4 col-12">
    			<div class="card" >
                     ...
                     <div class="card-body">
                        <h4 class="card-title">Shajeck veli</h4>
                        <p class="card-text"></p>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-4 col-lg-4 col-12">
				<img src="images/a1.jpg" class="img-fluid pd-4">
...
<section class="my-5">
	...
	<div class="w-50 m-auto">
		<form action="userinfo.php" method="post">
			...
			<div class="form-group">
				<label>Mail Id</label>
				<input type="text" name="mail" autocomplete="off" class="form-control">
			</div>
...
<footer>
	<p class="p-3 bg-dark text-white text-center">Thanks</p>
</footer>
